...
var DigitalClock = React4.forwardRef(function DigitalClock2(inProps, ref) {
  ...
  const isTimeDisabled = React4.useCallback((valueToCheck) => {
  ...
  const timeOptions = React4.useMemo(() => {
    const result = [];
  ...
  return (0, import_jsx_runtime3.jsx)(DigitalClockRoot, _extends({
    ref: handleRef,
    className: clsx_default(classes.root, className),
    ownerState
  }, other, {
    children: (0, import_jsx_runtime3.jsx)(DigitalClockList, {
      ref: listRef,
      role: "listbox",
      ...
      children: timeOptions.map((option, index) => {
        ...
        return (0, import_jsx_runtime3.jsx)(ClockItem, _extends({
...
var _excluded4 = ["autoFocus", "onChange", "className", "classes", "disabled", "readOnly", "items", "active", "slots", "slotProps", "skipDisabled"];
...
var MultiSectionDigitalClockSection = React5.forwardRef(function MultiSectionDigitalClockSection2(inProps, ref) {
  const containerRef = React5.useRef(null);
  const handleRef = useForkRef(ref, containerRef);
  const previousActive = React5.useRef(null);
  const props = useThemeProps({
    props: inProps,
    name: "MuiMultiSectionDigitalClockSection"
  });
  ...
  return (0, import_jsx_runtime4.jsx)(MultiSectionDigitalClockSectionRoot, _extends({
    ref: handleRef,
    className: clsx_default(classes.root, className),
    ownerState,
    ...
    children: items.map((option, index) => {
      ...
      return (0, import_jsx_runtime4.jsx)(DigitalClockSectionItem, _extends({
...
var MultiSectionDigitalClock = React6.forwardRef(function MultiSectionDigitalClock2(inProps, ref) {
  const utils = useUtils();
  const isRtl = useRtl();
  const props = useThemeProps({
    props: inProps,
  ...
  const translations = usePickerTranslations();
  const now = useNow(timezone);
  const timeSteps = React6.useMemo(() => _extends({
    hours: 1,
    minutes: 5,
    seconds: 5
  ...
  const buildViewProps = React6.useCallback((viewToBuild) => {
    switch (viewToBuild) {
      case "hours": {
        return {
          onChange: (hours) => {
  ...
  const viewsToRender = React6.useMemo(() => {
    if (!isRtl) {
      return views;
    }
  ...
  const viewTimeOptions = React6.useMemo(() => {
  ...
  return (0, import_jsx_runtime5.jsx)(MultiSectionDigitalClockRoot, _extends({
    ref,
    className: clsx_default(classes.root, className),
    ownerState,
    role: "group"
  }, other, {
    children: viewsToRender.map((timeView) => (0, import_jsx_runtime5.jsx)(MultiSectionDigitalClockSection, {
...
true ? MultiSectionDigitalClock.propTypes = {
   ...
   * Controlled focused view.
   */
  focusedView: import_prop_types2.default.oneOf(["hours", "meridiem", "minutes", "seconds"]),
  /**
   * Maximal selectable time.
   * The date part of the object will be ignored unless `props.disableIgnoringDatePartForTimeValidation === true`.
   */
   ...
   * Must be a valid option from `views` list.
   */
  openTo: import_prop_types2.default.oneOf(["hours", "meridiem", "minutes", "seconds"]),
  /**
   * If `true`, the component is read-only.
   * When read-only, the value cannot be changed but the user can interact with the interface.
   * @default false
   ...
   * Must be a valid option from `views` list.
   */
  view: import_prop_types2.default.oneOf(["hours", "meridiem", "minutes", "seconds"]),
  /**
   * Available views.
   * @default ['hours', 'minutes']
   */
  views: import_prop_types2.default.arrayOf(import_prop_types2.default.oneOf(["hours", "meridiem", "minutes", "seconds"]).isRequired)
} : void 0;
...
var renderTimeViewClock = ({
  ...
  timezone
}) => (0, import_jsx_runtime11.jsx)(TimeClock, {
  view,
  onViewChange,
...
var renderDigitalClockTimeView = ({
  ...
  skipDisabled,
  timezone
}) => (0, import_jsx_runtime11.jsx)(DigitalClock, {
  view,
  onViewChange,
  focusedView: focusedView && isTimeView(focusedView) ? focusedView : null,
  onFocusedViewChange,
...
var renderMultiSectionDigitalClockTimeView = ({
  ...
  skipDisabled,
  timezone
}) => (0, import_jsx_runtime11.jsx)(MultiSectionDigitalClock, {
  view,
  onViewChange,
...
//# sourceMappingURL=chunk-GJO6BIMU.js.map
