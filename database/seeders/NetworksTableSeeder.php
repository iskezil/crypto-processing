  ...
  public function run(): void
  {
    $networks = [
      ...
      [
        ...
        // HD
        'hd_coin_type'     => 0,
        // формат лучше уточнить, но как минимум зафиксируем тип
        'hd_address_format'=> 'btc_p2wpkh',
      ],
      [
        'code'             => 'LITECOIN',
        'name'             => 'Litecoin',
      ...
      [
        ...
        'active'           => true,
        'is_public'        => true,
        // HD (TON coin_type часто указывают 607)
        'hd_coin_type'     => 607,
        'hd_address_format'=> 'ton',
      ],
      [
        'code'             => 'SOLANA',
        'name'             => 'Solana',
        ...
        'active'           => true,
        'is_public'        => true,
        // HD (Solana coin_type часто 501)
        'hd_coin_type'     => 501,
        'hd_address_format'=> 'sol_base58',
      ],
      [
        'code'             => 'BASE',
        'name'             => 'Base',
