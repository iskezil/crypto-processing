...
export default function ModerationList({ projects, status }: { projects: Project[]; status: ModerationStatus }) {
  ...
  const statusSlug = status === 'pending' ? 'moderation' : status === 'approved' ? 'active' : status;
                ...
                <TableBody>
                  {projects.map((project) => (
                    <TableRow key={project.id} hover>
                      ...
                      <TableCell>
                        <Button href={route('projects_admin.show', [statusSlug, project.ulid], false)} color="inherit">
                          {project.name}
                        </Button>
                      </TableCell>
                      ...
                      <TableCell>
                        <Stack direction="row" spacing={1} alignItems="center">
                          <IconButton href={route('projects_admin.show', [statusSlug, project.ulid], false)} color="primary" size="small">
